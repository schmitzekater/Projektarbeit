...
<h4>Eintrag durch  <b><?php echo $_SESSION['name'] ; ?></b></h4>
	...
	<?php
		...
		mysql_query("delete from laeufer where id = $id");
		
		//DB-Abfrage
		$result = mysql_query("Select * from laeufer order by id desc");
		print("<em>Eintrag gel&ouml;scht</em><br>\n");
		print("<table><tr><th>Startnummer</th><th>Name</th><th>Alter</th><th>Gewicht</th></tr>");
