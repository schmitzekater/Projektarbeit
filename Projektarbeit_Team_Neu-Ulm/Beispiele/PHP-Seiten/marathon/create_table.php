...
<h4>Eintrag durch  <b><?php echo $_SESSION['name'] ; ?></b></h4>
	...
	<?php
		...
		mysql_query("create table laeufer (ID int primary key, name varchar(20), jahre int, gewicht int)");
		
		
		print("Tabelle erstellt. <br><a href = admin_einf.php>L&auml;ufer eintragen</a>");
